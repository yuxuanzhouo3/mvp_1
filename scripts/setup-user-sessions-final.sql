-- Final setup for user sessions and login tracking
-- This script properly handles dropping existing functions and recreating them
-- Run this in your Supabase Dashboard > SQL Editor

-- Drop existing functions with specific parameter lists
DROP FUNCTION IF EXISTS log_user_login(UUID, TEXT, INET, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS log_user_login(UUID, TEXT);
DROP FUNCTION IF EXISTS log_user_login(UUID, TEXT, INET);
...
DROP POLICY IF EXISTS "Users can insert their own login history" ON user_login_history;
...
GRANT EXECUTE ON FUNCTION log_user_login(UUID, TEXT, INET, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION log_user_logout(UUID, TEXT) TO authenticated;
