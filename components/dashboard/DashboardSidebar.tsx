  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center h-16 border-b px-4">
          <h1 className={`text-xl font-bold text-primary transition-opacity duration-200 ${open ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden'}`}>{isChinaDeployment() ? '摩尔相亲' : 'PersonaLink'}</h1>
      </div>
